...
> Verificamos la ruta del ejecutable con `icacls`. Si tenemos permisos, podemos sobrescribir el ejecutable con nuestro binario
...
powershell
> [!tip] Herramientas automáticas de enumeración En lugar de lanzar los comandos uno a uno, estas herramientas automatizan toda la enumeración:
> 
