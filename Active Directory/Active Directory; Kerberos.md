...
[[Active Directory; Kerberos#1.🔐 Qué es Kerberos]]
- [[Active Directory; Kerberos#1.1. 🎟️ Los tickets las llaves del sistema]]
- [[Active Directory; Kerberos#1.2. 🏛️ El KDC por dentro]]
- [[Active Directory; Kerberos#1.3. 🏷️ SPN — Service Principal Name]]
- [[Active Directory; Kerberos#1.4. 🔄 El flujo completo de autenticación]]
- [[Active Directory; Kerberos#1.5. 🗝️ Resumen de claves y quién las conoce]]
[[Active Directory; Kerberos#2. 🔐 Autenticación por Kerberos]]
[[Active Directory; Kerberos#3. ⚔️ Ataques Kerberos]]
- [[Active Directory; Kerberos#3.1. Enumeración y fuerza bruta con Kerbrute]]
- [[Active Directory; Kerberos#3.2. AS-REP Roasting]]
- [[Active Directory; Kerberos#3.3. Kerberoasting]]
- [[Active Directory; Kerberos#3.4. Ataques de creación de tickets]]
	- [[Active Directory; Kerberos#3.4.1. Golden Ticket]]
	- [[Active Directory; Kerberos#3.4.2. Silver Ticket]]
- [[Active Directory; Kerberos#3.5. Ataques de Delegación]]
	- [[Active Directory; Kerberos#3.5.1. Unconstrained Delegation]]
	- [[Active Directory; Kerberos#3.5.2. Constrained Delegation]]
	- [[Active Directory; Kerberos#3.5.3 Resource-Based Constrained Delegation (RBCD)]]
